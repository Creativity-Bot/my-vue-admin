...
//营收统计图表
Mock.mock("http://www.demo.com/revenueChart", "get", () => {
  return {
    code: 200,
    success: true,
    data: {
...
// 定义 API 接口
Mock.mock("http://www.demo.com/revenueList", 'post', (options) => {
...
//充电桩列表接口
Mock.mock("http://www.demo.com/currentList", "post", () => {
  return {
    code: 200,
    success: true,
    data: chargingPile
...
//电子地图接口
Mock.mock("http://www.demo.com/mapList", "post", () => {
  return {
    code: 200,
    success: true,
    data: stations
...
Mock.mock("http://www.demo.com/addMap", "post", (data) => {
  const payload = JSON.parse(data.body);
  let newStation = {
    position: [payload.location1, payload.location2],
    title: payload.name,
    status: payload.now,
    count: 0,
  }
