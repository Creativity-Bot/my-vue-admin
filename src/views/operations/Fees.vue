            ...
            <el-card>
                ...
                <el-form ref="formRef" :model="form" :rules="rules" label-width="auto">
                    <el-form-item label="模版名称" prop="name">
                        <el-input v-model="form.name" placeholder="请输入模版名称" style="width: 40%;"/>
                    </el-form-item>
                        ...
                        <el-row :gutter="20" style="width: 60%;">
                            <el-col :span="8">
                                <el-form-item label="开始时间" :prop="`date.${index}.startTime`" :rules="[{ required: true, message: '请选择开始时间', trigger: 'blur' }]">
                                    <el-time-picker v-model="item.startTime" placeholder="请选择开始时间" style="width: 100%;" value-format="HH:mm:ss"></el-time-picker>
                                </el-form-item>
                            </el-col>
                            <el-col :span="1">
                            ...
                            <el-col :span="8">
                                <el-form-item label="结束时间" :prop="`date.${index}.endTime`" :rules="[{ required: true, message: '请选择结束时间', trigger: 'blur' }]">
                                    <el-time-picker v-model="item.endTime" placeholder="请选择结束时间" style="width: 100%;" value-format="HH:mm:ss"></el-time-picker>
                                </el-form-item>     
                            </el-col>
                            <el-col :span="6">
                                <el-form-item label="单价" :prop="`date.${index}.unitPrice`" :rules="[{ required: true, message: '请输入单价', trigger: 'blur' }]">
                                    <el-input v-model="item.unitPrice" placeholder="请输入单价" style="width: 100%;"/>
                                </el-form-item>
                            </el-col>
                        </el-row>
                    </el-form-item>
                    <el-button class="mb" type="primary" @click="addTime">新增收费时段</el-button>
                    <el-form-item label="服务费" prop="serviceFee">
                        <el-input v-model="form.serviceFee" placeholder="请输入服务费" style="width: 40%;"/>
                    </el-form-item>
                    <el-form-item label="停车费" prop="parkingFee">
                        <el-input v-model="form.parkingFee" placeholder="请输入停车费" style="width: 40%;"/>
                    </el-form-item>
